...
//<img  classname="bannerImg  h-4/6" src={bannerImg} alt="banner"/>
  return (
    <>
    <div className="flex pt-10 h-auto md:h-screen overflow-hidden z-10" style={{backgroundImage: `url(${bannerImg})`, backgroundSize:"cover", backgroundRepeat:"no-repeat", backgroundPosition:"right bottom"}}>
      ...
      <div className="py-12 pl-4 w-full  md:pl-9 md:py-20 xl:pl-40 lg:py-36" >
        ...
        <p className="hidden text-white text-center px-5 py-2 bg-black rounded-3xl md:inline md:text-xl md:px-11 md:py-3.5 ">Shop me</p>
        ...
        <p className="inline text-white text-center  px-5 py-2 bg-black rounded-3xl md:hidden">Shop me</p>
